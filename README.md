...
Внимание! Это устаревший скрипт. На его основе был сделан сайт, рекомендуется пользоваться им: https://gescript.herokuapp.com/
...
## 2. Установка Python
Для запуска скрипта нужен установленный Python 3. Самый простой способ установить его - через Microsoft Store. Здесь и далее инструкция описывает процесс работы на Windows, но на Маке все примерно также. 
